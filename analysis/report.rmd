...
tar_load(annotated_module_stats_by_cluster)
...
```{r include=FALSE}
tar_load(module_scores_with_viral_by_cluster)
tar_load(module_scores_with_viral_by_cluster_stats)
...
module_cluster_graphs <-
  ...
  stat_pvalue_manual(
    ...
    label = 
      ifelse(
        test = ("p.adj.signif" %in% module_scores_with_viral_by_cluster_stats),
        yes = "p.adj.signif",
        no = "p"
      ),
    hide.ns = TRUE,
