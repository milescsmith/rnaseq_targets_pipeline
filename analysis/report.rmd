...
tar_load(wgcna_disease_class_rf_cv)
tar_load(wgcna_disease_class_test)
...
tar_read(wgcna_disease_class_rf_cv_varImp)
```
...
tar_load(module_disease_class_rf_cv)
tar_load(module_disease_class_test)
...
tar_read(module_disease_class_rf_cv_varImp)
```
