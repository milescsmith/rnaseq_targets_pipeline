...
```{r}
tar_read(deg_class, final_md, vsd_exprs, annotation_info, group_pal, up_tables, down_tables)
```
...
tar_read(module_scores_with_viral, ifn_modules)
```
...
```{r}
tar_read(annotated_modules, annotated_mod_list)
```
...
tar_read(wgcna_cluster_rf_cv, wgcna_cluster_test)
...
tar_read(wgcna_disease_class_rf_cv, wgcna_disease_class_test)
...
tar_read(module_cluster_rf_cv, module_cluster_test)
...
tar_read(module_disease_class_rf_cv, module_disease_class_test)
